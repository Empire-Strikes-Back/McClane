...
(defn -main [& args]
  ...
  (let [data-dir (-> (io/file (System/getProperty "user.dir")) (.getCanonicalPath))]
    ...
    (let [jframe (JFrame. "figwheel-calva-docker")]
      (doto jframe
        (.setDefaultCloseOperation JFrame/EXIT_ON_CLOSE)
        (.setSize 1600 1200)
        (.setLocationByPlatform true)
        (.setVisible true))
      (alter-var-root #'figwheel-calva-docker.main/jframe (constantly jframe)))
